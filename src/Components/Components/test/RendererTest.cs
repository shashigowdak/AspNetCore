...
namespace Microsoft.AspNetCore.Components.Test
{
    public class RendererTest
    {
        ...
        [Fact]
        public void CannotDispatchEventsWithUnknownEventHandlers()
        {
            // Arrange
            var renderer = new TestRenderer();
            ...
            {
                renderer.DispatchEventAsync(0, new UIEventArgs());
            });
        }
        ...
        public void DisposesEventHandlersWhenAttributeValueChanged()
        {
            ...
            renderer.DispatchEventAsync(origEventHandlerId, args: null);
            ...
            renderer.DispatchEventAsync(origEventHandlerId + 1, args: null);
        ...
        public void DisposesEventHandlersWhenOwnerComponentRemoved()
        {
            ...
            // Act/Assert 1: Event handler fires when we trigger it
            Assert.Equal(0, eventCount);
            renderer.DispatchEventAsync(eventHandlerId, args: null);
            Assert.Equal(1, eventCount);
        ...
        public void CanCombineBindAndConditionalAttribute()
        {
            ...
            renderer.DispatchEventAsync(checkboxChangeEventHandlerId, eventArgs);
        ...
        public async Task CanTriggerEventHandlerDisposedInEarlierPendingBatch()
        {
            ...
            {
                renderer.DispatchEventAsync(eventHandlerId, new UIEventArgs());
            });
